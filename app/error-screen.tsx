...
/**
 * The not-found screen, shared by the route and by Next's catch-all.
 *
 * **One component, two entry points.** `/error-404` is a real address in the sidebar, because a buyer
 * wants to look at the screen without breaking a link to see it, and `not-found.tsx` is what Next
 * renders for anything unmatched. They are the same screen, so they are the same file: two copies of
 * an error page is how one of them ends up saying something the other does not.
 *
  ...
  return (
    <main className="relative z-10 flex min-h-dvh flex-col items-center justify-center overflow-hidden p-6">
      ...
      <div className="mx-auto w-full max-w-[472px] text-center">
        ...
        <NextLink href="/" className="mt-8 inline-block">
